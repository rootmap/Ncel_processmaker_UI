    ...
    <div class="container d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-stretch mr-3">
            ...
            <div class="header-logo">
                <a href="index.html">
                    <img alt="Logo" src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/logos/logo-letter-9.png')); ?> " class="logo-default max-h-40px" />
                    <img alt="Logo" src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/logos/logo-letter-1.png')); ?> " class="logo-sticky max-h-40px" />
                </a>
            </div>
            <!--end::Header Logo-->
        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        <!--begin::Header-->
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url( <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/misc/bg-1.jpg')); ?> )">
                            <!--begin::Title-->
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <!--begin:Header-->
                    <div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url( <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/misc/bg-1.jpg')); ?> )">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                    <form>
                        <!--begin::Header-->
                        <div class="d-flex align-items-center py-10 px-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url( <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/misc/bg-1.jpg')); ?> )">
                        ...
                        <div class="scroll scroll-push" data-scroll="true" data-height="250" data-mobile-height="200">
                            ...
                            <div class="d-flex align-items-center justify-content-between p-8">
                                ...
                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/stock-600x400/img-1.jpg')); ?> " title="" alt="" />
                                </a>
                            </div>
                            <!--end::Item-->
                            <!--begin::Separator-->
                            ...
                            <div class="d-flex align-items-center justify-content-between p-8">
                                ...
                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/stock-600x400/img-2.jpg')); ?> " title="" alt="" />
                                </a>
                            </div>
                            <!--end::Item-->
                            <!--begin::Separator-->
                            ...
                            <div class="d-flex align-items-center justify-content-between p-8">
                                ...
                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/stock-600x400/img-3.jpg')); ?> " title="" alt="" />
                                </a>
                            </div>
                            <!--end::Item-->
                            <!--begin::Separator-->
                            ...
                            <div class="d-flex align-items-center justify-content-between p-8">
                                ...
                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/stock-600x400/img-4.jpg')); ?> " title="" alt="" />
                                </a>
                            </div>
                            <!--end::Item-->
                        </div>
...
<?php /**PATH H:\learning\htdocs\processmaker_ncel\resources\views/layout/backend/partial/header.blade.php ENDPATH**/ ?>