...
<head>
    ...
    <link href=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundlef552.css?v=7.1.8')); ?> " rel="stylesheet" type="text/css" />
    <!--end::Page Vendors Styles-->
    <!--begin::Global Theme Styles(used by all pages)-->
    <link href=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/plugins/global/plugins.bundlef552.css?v=7.1.8')); ?> " rel="stylesheet" type="text/css" />
    <link href=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/plugins/custom/prismjs/prismjs.bundlef552.css?v=7.1.8')); ?> " rel="stylesheet" type="text/css" />
    <link href=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/css/style.bundlef552.css?v=7.1.8')); ?> " rel="stylesheet" type="text/css" />
...
<body id="kt_body" style="background-image: url(<?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/bg/bg-10.jpg')); ?>)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
    ...
    <!--begin::Header Mobile-->
    <?php echo $__env->make('layout.backend.partial.mobile-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end::Header Mobile-->
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <!--begin::Header-->
                <?php echo $__env->make('layout.backend.partial.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!--end::Header-->
                ...
                <!--begin::Footer-->
                <?php echo $__env->make('layout.backend.partial.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!--end::Footer-->
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label" style="background-image:url(' <?php echo e(asset('assest/backend/theme/html/demo2/dist/assets/media/users/300_21.jpg')); ?>')"></div>
                                ...
                                <div class="d-flex flex-column mb-5 align-items-start">
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-circle symbol-40 mr-3">
                                            <img alt="Pic" src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/users/300_12.jpg')); ?> " />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex flex-column mb-5 align-items-end">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-circle symbol-40 ml-3">
                                            <img alt="Pic" src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/users/300_21.jpg')); ?> " />
                                        </div>
                                    </div>
        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo1.png')); ?> " alt="" class="w-100" />
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo2.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo3.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo4.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo5.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo6.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo7.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo8.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo9.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo10.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo11.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo12.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo13.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo14.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo15.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo16.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo17.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo18.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo19.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo20.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo21.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo22.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo23.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo24.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo25.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo26.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo27.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo28.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo29.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/media/demos/demo30.png')); ?> " alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming soon</a>
                </div>
    ...
    <script src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/plugins/global/plugins.bundlef552.js?v=7.1.8')); ?> "></script>
    <script src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/plugins/custom/prismjs/prismjs.bundlef552.js?v=7.1.8')); ?> "></script>
    <script src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/js/scripts.bundlef552.js?v=7.1.8')); ?> "></script>
    <!--end::Global Theme Bundle-->
    <!--begin::Page Vendors(used by this page)-->
    <script src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundlef552.js?v=7.1.8')); ?> "></script>
    <!--end::Page Vendors-->
    <!--begin::Page Scripts(used by this page)-->
    <script src=" <?php echo e(asset('assets/backend/theme/html/demo2/dist/assets/js/pages/widgetsf552.js?v=7.1.8')); ?> "></script>
    <!--end::Page Scripts-->
...
<?php /**PATH H:\learning\htdocs\processmaker_ncel\resources\views/layout/backend/master.blade.php ENDPATH**/ ?>