                    ...
                    <div class="col-xl-8">
                        <div class="row">
                            <div class="col-xl-3">
                                ...
                                <div class="card card-custom bgi-no-repeat bgi-no-repeat bgi-size-cover gutter-b" style="height: 150px; background-image: url( {{ asset('assets/backend/theme/html/demo2/dist/assets/media/bg/bg-9.jpg') }} )">
                                    <!--begin::Body-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch" style="background-image: url( {{ asset('assets/backend/theme/html/demo2/dist/assets/media/stock-600x600/img-16.jpg') }} )">
                                    <!--begin::Body-->
