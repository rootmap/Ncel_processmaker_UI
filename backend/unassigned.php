...
<body>
  ...
  <div class="wrapper container">
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header" style="height: 45px !important;"><h4 class="mt-0 header-title mb-5"><i class="mdi mdi-email"></i> Unassigned Case</h4>
                </div>
                <div class="card-body">
                          ...
                          <tbody>
                            <?php 
                              if (!empty($unassigned)) {
                                ...
                                foreach ($unassigned->cases as $key => $d) {
                            ?>
                                  <tr>
